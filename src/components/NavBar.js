    ...
    return (<>
        <nav className='shadow-md w-full top-0 left-0'>
            <div className='flex md:flex items-center justify-between bg-zinc-800 py-4 md:px-10 px-7'>
                ...
                <ul className={`md:flex md:items-center md:static md:pb-0 absolute pb-4 left-0 md:z-auto pl-5 w-1/2 md:w-auto transition-all duration-500 ease-in bg-zinc-800 ${abierto ? 'top-20 opacity-100 z-1' : 'top-[-500] z-[-1]'} md:opacity-100`}>
                    {
                        Links.map((item) => (
